        ...
        <div className={styles.settingsPanel}>
            ...
            <CollapsibleSection title="General">
                <div className={styles.inputGroup}>
                    <label htmlFor="src">Embed URL:</label>
                    <input
                        id="src"
                        type="text"
                        value={props.src || ""}
                ...
                <div className={styles.inputGroup}>
                    <label htmlFor="allowFullScreen">Allow Full Screen:</label>
                    <select
                        id="allowFullScreen"
                        value={props.allowFullScreen ? "true" : "false"}
                        onChange={e => setProp(p => p.allowFullScreen = e.target.value === "true")}
                    >
